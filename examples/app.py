...
app.config["CIRCULATION_ITEM_REF_BUILDER"] = lambda loan_pid, loan: {
    "ref": "{}".format(loan_pid)
}
app.config["CIRCULATION_PATRON_REF_BUILDER"] = lambda loan_pid, loan: {
    "ref": "{}".format(loan_pid)
}
app.config["CIRCULATION_DOCUMENT_REF_BUILDER"] = lambda loan_pid, loan: {
    "ref": "{}".format(loan_pid)
}
